...
_$RepairmanDetailsModelImpl _$$RepairmanDetailsModelImplFromJson(
  Map<String, dynamic> json,
) => _$RepairmanDetailsModelImpl(
...
Map<String, dynamic> _$$RepairmanDetailsModelImplToJson(
  _$RepairmanDetailsModelImpl instance,
) => <String, dynamic>{
  'id': instance.id,
